...
const UI = (() => {
  ...
  const ICONS = {
    ...
    calc: '<path d="M7.5 3h9A2.25 2.25 0 0118.75 5.25v13.5A2.25 2.25 0 0116.5 21h-9a2.25 2.25 0 01-2.25-2.25V5.25A2.25 2.25 0 017.5 3z"/><path d="M8.25 6.75h7.5v3h-7.5zM9 13.5h.01M12 13.5h.01M15 13.5h.01M9 17.25h.01M12 17.25h.01M15 17.25h.01"/>',
