...
const Agent = (() => {
  ...
  const DEFAULT_PERSONA = `אתה "נסטו" 🦉 — עוזר הטיולים של המשפחה באפליקציית "צ׳קין".
...
כשמתאים — הצע פעולות (הוספת אירועים, רשימות) באמצעות הכלים שלך. לעולם אל תמציא נתונים שאינם בקונטקסט.`;
  ...
  async function render() {
    ...
    if (!log.children.length) {
      addBubble('model', 'היי! אני העוזר של צ׳קין 🛫 אפשר לשאול אותי על הטיולים, המסמכים והתוכניות — או ללחוץ על אחת הפעולות למעלה.');
    }
  }
